...
>(({ className, ...props }, ref) => (
    <MenubarPrimitive.Root
        ref={ref}
        className={cn(
            'flex h-9 items-center space-x-1 border-secondary rounded-md border bg-background p-1 shadow-sm',
            className
        )}
        {...props}
    />
...
>(({ className, ...props }, ref) => (
    <MenubarPrimitive.Trigger
        ref={ref}
        className={cn(
            'flex cursor-default select-none items-center border-secondary rounded-sm px-3 py-1 text-sm font-medium outline-none focus:bg-muted focus:text-accent-foreground data-[state=open]:bg-muted data-[state=open]:text-accent-foreground',
            className
        )}
        {...props}
    />
    ...
    (
        ...
        <MenubarPrimitive.Portal>
            <MenubarPrimitive.Content
                ...
                className={cn(
                    'z-50 min-w-[12rem] overflow-hidden border-secondary rounded-md border bg-popover p-1 text-popover-foreground shadow-md data-[state=open]:animate-in data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2',
                    className
                )}
                {...props}
            />
